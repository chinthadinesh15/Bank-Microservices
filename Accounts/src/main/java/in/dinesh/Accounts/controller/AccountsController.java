...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API's to create new Customer & Account"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API's to fetch account details"
    )
    @ApiResponse(
            responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API's to update account details"
    )
    @ApiResponses(
            value = {
    ...
    @Operation(
            ...
            description = "REST API's to delete account details"
    )
    @ApiResponses(
            value = {
